      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView style={[styles.content, { backgroundColor: theme.bg }]}>
          ...
          <View style={styles.titleSection}>
            <View>
              <Text style={[styles.pageTitle, { color: theme.text }]}>Package Type Management</Text>
              <Text style={[styles.subtitle, { color: theme.textSecondary }]}>Manage package types and categories</Text>
            </View>
            <TouchableOpacity style={[styles.createButton, { backgroundColor: Palette.primary }]}>
              <Ionicons name="add" size={20} color={Palette.black} />
              <Text style={styles.createButtonText}>Add Package Type</Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={[styles.placeholderContainer, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            <Text style={[styles.placeholderText, { color: theme.text }]}>Package Type Management</Text>
