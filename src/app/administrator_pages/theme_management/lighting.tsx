...
export default function LightingManagement() {
  ...
  // Mock data for Lighting
  const mockLightingStyles = [
    {
      id: 1,
      style_name: "Warm Ambient",
      createdDate: "2024-01-15",
      lastUpdated: "2024-12-10",
    },
    {
      id: 2,
      style_name: "Fairy Lights",
      createdDate: "2024-01-20",
      lastUpdated: "2024-12-05",
    },
    {
      id: 3,
      style_name: "LED Uplighting",
      createdDate: "2024-02-01",
      lastUpdated: "2024-11-28",
    },
    {
      id: 4,
      style_name: "Crystal Chandeliers",
      createdDate: "2024-02-10",
      lastUpdated: "2024-10-15",
    },
    {
      id: 5,
      style_name: "Gobo Projection",
      ...
      <View style={[styles.container, { backgroundColor: theme.bg }]}>
        ...
        <View style={styles.mainContainer}>
          ...
          <View style={[styles.loadingContainer, { backgroundColor: theme.bg }]}>
            ...
            <Text style={[styles.loadingText, { color: theme.text }]}>Loading lighting styles...</Text>
          </View>
        </View>
      </View>
    );
      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView style={[styles.content, { backgroundColor: theme.bg }]}>
          ...
          <View style={styles.titleSection}>
            <View>
              <Text style={[styles.pageTitle, { color: theme.text }]}>Lighting Styles</Text>
              <Text style={[styles.subtitle, { color: theme.textSecondary }]}>Manage lighting options for events</Text>
            </View>
          ...
          <View style={[styles.tableContainer, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            {/* Table Rows */}
            {filteredLightingStyles.length === 0 ? (
              <View style={[styles.emptyContainer, { backgroundColor: theme.bg }]}>
                <Ionicons name="search" size={48} color={theme.textSecondary} />
                <Text style={[styles.emptyText, { color: theme.text }]}>No lighting styles found</Text>
              </View>
            ) : (
              filteredLightingStyles.map((style) => (
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.card }]}>
            <View style={styles.modalHeader}>
              <View>
                <Text style={[styles.modalTitle, { color: theme.text }]}>Add Lighting Style</Text>
                <Text style={[styles.modalSubtitle, { color: theme.textSecondary }]}>Create a new lighting style</Text>
              </View>
      ...
      <Modal visible={showEditModal} transparent animationType="fade" onRequestClose={handleCancelEditModal}>
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: theme.card }]}>
            <View style={styles.modalHeader}>
              <View>
                <Text style={[styles.modalTitle, { color: theme.text }]}>Edit Lighting Style</Text>
