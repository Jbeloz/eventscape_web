...
export default function AddOnsCategoryManagement() {
      ...
      <View style={styles.mainContainer}>
        ...
        <ScrollView style={[styles.content, { backgroundColor: theme.bg }]}>
          ...
          <View style={styles.titleSection}>
            <View>
              <Text style={[styles.pageTitle, { color: theme.text }]}>Add Ons Category Management</Text>
          ...
          <View style={[styles.placeholderContainer, { backgroundColor: theme.card, borderColor: theme.border }]}>
            ...
            <Text style={[styles.placeholderText, { color: theme.text }]}>Add Ons Category Management</Text>
